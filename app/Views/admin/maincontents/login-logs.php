        ...
        <div class="card table-card">
          <div class="card-body pt-3">
            ...
            <ul class="nav nav-tabs nav-tabs-bordered">
              <li class="nav-item">
                <button class="nav-link font-12 active" data-bs-toggle="tab" data-bs-target="#tab1">ADMIN</button>
              </li>
              <li class="nav-item">
                <button class="nav-link font-12" data-bs-toggle="tab" data-bs-target="#tab2">USER</button>
              </li>
              <li class="nav-item">
                <button class="nav-link font-12" data-bs-toggle="tab" data-bs-target="#tab3">CLIENT</button>
              </li>
              <li class="nav-item">
                <button class="nav-link font-12" data-bs-toggle="tab" data-bs-target="#tab4">SALES</button>
              </li>
            </ul>
