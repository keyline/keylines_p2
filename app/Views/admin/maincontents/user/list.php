                                        ...
                                        foreach ($rows as $row) { ?>
                                            <tr>
                                                ...
                                                <td><?= $row->name ?><span class="badge bg-warning ms-1"><?= $row->id ?></span> <br>
                                                    <a href="<?= base_url('admin/user/screenshots/' . encoded($row->id)); ?>"> Screenshots(<?= (!empty($row->screenshot_time)) ? date("g:i A", strtotime($row->screenshot_time)) : "no tracking" ?>) <i class="fas fa-image"></i> </a>                                                    
                                                </td>
