                            ...
                            <div class="modal" id="holidayModal">
                                <div class="modal-dialog">
                                    <div class="modal-content">        
                                        ...
                                        <h5 class="modal-title">Create event for <span id="eventDate1"></span></h5>
                                        ...
                                        <div class="modal-body">
                                            <form id="holidayForm" method="POST">
                                                ...
                                                <div class="form-group">
                                                    <button type="submit" id="dataForm" class="btn btn-primary btn-sm mt-2" data-dismiss="modal">Save</button>                          
                                                </div> 
                                            </form>                   
                                        </div>        
                                    </div>                                                
