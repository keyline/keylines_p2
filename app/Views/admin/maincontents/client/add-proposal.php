                        ...
                        <form method="POST" action="" enctype="multipart/form-data">
                            <div class="row mb-2">
                                <div class="col-md-4 col-lg-3">
                                    <label for="proposal_title" class="col-form-label">Document Title <span style="color:red">*</span></label>
                                </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-4 col-lg-3">
                                    <label for="proposal_description" class="col-form-label">Document Description</label>
                                </div>
                                <div class="col-md-8 col-lg-9">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-4 col-lg-3">
                                    <label for="proposal_file" class="col-form-label">Files <span style="color:red">*</span></label>
                                </div>
                                <div class="col-md-8 col-lg-9">
