        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card table-card">
                    <?php if (checkModuleFunctionAccess(32, 90)) { ?>
                    ...
                    <div class="card-body">
                        <div class="dt-responsive table-responsive">
                            <?php if (checkModuleFunctionAccess(32, 89)) { ?>
                                <table id="simpletable" class="table padding-y-10 general_table_style">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (checkModuleFunctionAccess(32, 91)) { ?>
                                                ...
                                                <?php } ?>
                                                <?php if (checkModuleFunctionAccess(32, 94)) { ?>
                                                ...
                                                <?php } ?>
                                                <?php if($row->status){?>
                                                    <?php if (checkModuleFunctionAccess(32, 92)) { ?>
                                                    ...
                                                    <?php } ?>
                                                <?php } else {?>
                                                    <?php if (checkModuleFunctionAccess(32, 93)) { ?>
