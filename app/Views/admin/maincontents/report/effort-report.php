                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php if ($response['deskloguser'] == 1) {
                                                                    if ($response['jan_desklog'] > 0) { ?><span class="badge" <?= (($response['jan_desklog'] >= 172) ? 'style="background-color: #28c009;"' : 'style="background-color: #e3468f;"') ?>>D: <?= $response['jan_desklog'] ?></span><?php }
                                                                                                                                                                                                                                                                                        } ?>
                                                            </td>
                                                            <td>
                                                                ...
                                                                <?php if ($response['deskloguser'] == 1) {
                                                                    if ($response['feb_desklog'] > 0) { ?><span class="badge" <?= (($response['feb_desklog'] >= 172) ? 'style="background-color: #28c009;"' : 'style="background-color: #e3468f;"') ?>>D: <?= $response['feb_desklog'] ?></span><?php }
                                                                                                                                                                                                                                                                                        } ?>
                                                            </td>
                                                            <td>
                                                                ...
                                                                <?php if ($response['deskloguser'] == 1) {
                                                                    if ($response['mar_desklog'] > 0) { ?><span class="badge" <?= (($response['mar_desklog'] >= 172) ? 'style="background-color: #28c009;"' : 'style="background-color: #e3468f;"') ?>>D: <?= $response['mar_desklog'] ?></span><?php }
                                                                                                                                                                                                                                                                                        } ?>
                                                            </td>
                                                            <td>
                                                                ...
                                                                <?php if ($response['deskloguser'] == 1) {
                                                                    if ($response['apr_desklog'] > 0) { ?><span class="badge" <?= (($response['apr_desklog'] >= 172) ? 'style="background-color: #28c009;"' : 'style="background-color: #e3468f;"') ?>>D: <?= $response['apr_desklog'] ?></span><?php }
                                                                                                                                                                                                                                                                                        } ?>
                                                            </td>
                                                            <td>
                                                                ...
                                                                <?php if ($response['deskloguser'] == 1) {
                                                                    if ($response['may_desklog'] > 0) { ?><span class="badge" <?= (($response['may_desklog'] >= 172) ? 'style="background-color: #28c009;"' : 'style="background-color: #e3468f;"') ?>>D: <?= $response['may_desklog'] ?></span><?php }
                                                                                                                                                                                                                                                                                        } ?>
                                                            </td>
                                                            <td>
                                                                ...
                                                                <?php if ($response['deskloguser'] == 1) {
                                                                    if ($response['jun_desklog'] > 0) { ?><span class="badge" <?= (($response['jun_desklog'] >= 172) ? 'style="background-color: #28c009;"' : 'style="background-color: #e3468f;"') ?>>D: <?= $response['jun_desklog'] ?></span><?php }
                                                                                                                                                                                                                                                                                        } ?>
                                                            </td>
                                                            <td>
                                                                ...
                                                                <?php if ($response['deskloguser'] == 1) {
                                                                    if ($response['jul_desklog'] > 0) { ?><span class="badge" <?= (($response['jul_desklog'] >= 172) ? 'style="background-color: #28c009;"' : 'style="background-color: #e3468f;"') ?>>D: <?= $response['jul_desklog'] ?></span><?php }
                                                                                                                                                                                                                                                                                        } ?>
                                                            </td>
                                                            <td>
                                                                ...
                                                                <?php if ($response['deskloguser'] == 1) {
                                                                    if ($response['aug_desklog'] > 0) { ?><span class="badge" <?= (($response['aug_desklog'] >= 172) ? 'style="background-color: #28c009;"' : 'style="background-color: #e3468f;"') ?>>D: <?= $response['aug_desklog'] ?></span><?php }
                                                                                                                                                                                                                                                                                        } ?>
                                                            </td>
                                                            <td>
                                                                ...
                                                                <?php if ($response['deskloguser'] == 1) {
                                                                    if ($response['sep_desklog'] > 0) { ?><span class="badge" <?= (($response['sep_desklog'] >= 172) ? 'style="background-color: #28c009;"' : 'style="background-color: #e3468f;"') ?>>D: <?= $response['sep_desklog'] ?></span><?php }
                                                                                                                                                                                                                                                                                        } ?>
                                                            </td>
                                                            <td>
                                                                ...
                                                                <?php if ($response['deskloguser'] == 1) {
                                                                    if ($response['oct_desklog'] > 0) { ?><span class="badge" <?= (($response['oct_desklog'] >= 172) ? 'style="background-color: #28c009;"' : 'style="background-color: #e3468f;"') ?>>D: <?= $response['oct_desklog'] ?></span><?php }
                                                                                                                                                                                                                                                                                        } ?>
                                                            </td>
                                                            <td>
                                                                ...
                                                                <?php if ($response['deskloguser'] == 1) {
                                                                    if ($response['nov_desklog'] > 0) { ?><span class="badge" <?= (($response['nov_desklog'] >= 172) ? 'style="background-color: #28c009;"' : 'style="background-color: #e3468f;"') ?>>D: <?= $response['nov_desklog'] ?></span><?php }
                                                                                                                                                                                                                                                                                        } ?>
                                                            </td>
                                                            <td>
                                                                ...
                                                                <?php if ($response['deskloguser'] == 1) {
                                                                    if ($response['dec_desklog'] > 0) { ?><span class="badge" <?= (($response['dec_desklog'] >= 172) ? 'style="background-color: #28c009;"' : 'style="background-color: #e3468f;"') ?>>D: <?= $response['dec_desklog'] ?></span><?php }
                                                                                                                                                                                                                                                                                        } ?>
                                                            </td>
                                                        </tr>
                                                <?php }
