                                ...
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-md-6 col-lg-6" style="margin-top: 20px;">
                                        ...
                                        <?php if (!empty($response)) { ?>
                                            <a href="<?= base_url('admin/reports/advance-search') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-refresh"></i> Reset</a>
                                        <?php } ?>
                                    </div>
                                </div>
                            </form>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <?php if ($response['deskloguser'] == 1) {
                                                                      if($response['jan_desktop'] !== '' && $response['jan_desktop'] !== null){
                                                                        if ((explode(":", $response['jan_desktop'])[0] > 0) || (explode(":", $response['jan_desktop'])[1] > 0)) { ?><span class="badge <?= ((explode(":", $response['jan_desktop'])[0] >= 172) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="<?= base_url('public/uploads/desktop-app-icon.png')?>" alt="" class="desklog-icon"> <?= $response['jan_desktop'] ?></span><?php }
                                                                                                                                                                                                                                                                                            }} ?>
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    <?php if ($response['deskloguser'] == 1) {
                                                                      if($response['feb_desktop'] !== '' && $response['feb_desktop'] !== null){  
                                                                        if ((explode(":", $response['feb_desktop'])[0] > 0) || (explode(":", $response['feb_desktop'])[1] > 0)) { ?><span class="badge <?= ((explode(":", $response['feb_desktop'])[0] >= 172) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="<?= base_url('public/uploads/desktop-app-icon.png')?>" alt="" class="desklog-icon"> <?= $response['feb_desktop'] ?></span><?php }
                                                                                                                                                                                                                                                                                            }} ?>
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    <?php if ($response['deskloguser'] == 1) {
                                                                       if($response['mar_desktop'] !== '' && $response['mar_desktop'] !== null){ 
                                                                        if ((explode(":", $response['mar_desktop'])[0] > 0) || (explode(":", $response['mar_desktop'])[1] > 0)) { ?><span class="badge <?= ((explode(":", $response['mar_desktop'])[0] >= 172) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="<?= base_url('public/uploads/desktop-app-icon.png')?>" alt="" class="desklog-icon"> <?= $response['mar_desktop'] ?></span><?php }
                                                                                                                                                                                                                                                                                            }} ?>
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    <?php if ($response['deskloguser'] == 1) {
                                                                       if($response['apr_desktop'] !== '' && $response['apr_desktop'] !== null){ 
                                                                        if ((explode(":", $response['apr_desktop'])[0] > 0) || (explode(":", $response['apr_desktop'])[1] > 0)) { ?><span class="badge <?= ((explode(":", $response['apr_desktop'])[0] >= 172) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="<?= base_url('public/uploads/desktop-app-icon.png')?>" alt="" class="desklog-icon"> <?= $response['apr_desktop'] ?></span><?php }
                                                                                                                                                                                                                                                                                            }} ?>
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    <?php if ($response['deskloguser'] == 1) {
                                                                       if($response['may_desktop'] !== '' && $response['may_desktop'] !== null){
                                                                        if ((explode(":", $response['may_desktop'])[0] > 0) || (explode(":", $response['may_desktop'])[1] > 0)) { ?><span class="badge <?= ((explode(":", $response['may_desktop'])[0] >= 172) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="<?= base_url('public/uploads/desktop-app-icon.png')?>" alt="" class="desklog-icon"> <?= $response['may_desktop'] ?></span><?php }
                                                                                                                                                                                                                                                                                            }} ?>
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    <?php if ($response['deskloguser'] == 1) {
                                                                       if($response['jun_desktop'] !== '' && $response['jun_desktop'] !== null){ 
                                                                        if ((explode(":", $response['jun_desktop'])[0] > 0) || (explode(":", $response['jun_desktop'])[1] > 0)) { ?><span class="badge <?= ((explode(":", $response['jun_desktop'])[0] >= 172) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="<?= base_url('public/uploads/desktop-app-icon.png')?>" alt="" class="desklog-icon"> <?= $response['jun_desktop'] ?></span><?php }
                                                                                                                                                                                                                                                                                            }} ?>
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    <?php if ($response['deskloguser'] == 1) {
                                                                       if($response['jul_desktop'] !== '' && $response['jul_desktop'] !== null){ 
                                                                        if ((explode(":", $response['jul_desktop'])[0] > 0) || (explode(":", $response['jul_desktop'])[1] > 0)) { ?><span class="badge <?= ((explode(":", $response['jul_desktop'])[0] >= 172) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="<?= base_url('public/uploads/desktop-app-icon.png')?>" alt="" class="desklog-icon"> <?= $response['jul_desktop'] ?></span><?php }
                                                                                                                                                                                                                                                                                            }} ?>
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    <?php if ($response['deskloguser'] == 1) {
                                                                       if($response['aug_desktop'] !== '' && $response['aug_desktop'] !== null){ 
                                                                        if ((explode(":", $response['aug_desktop'])[0] > 0) || (explode(":", $response['aug_desktop'])[1] > 0)) { ?><span class="badge <?= ((explode(":", $response['aug_desktop'])[0] >= 172) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="<?= base_url('public/uploads/desktop-app-icon.png')?>" alt="" class="desklog-icon"> <?= $response['aug_desktop'] ?></span><?php }
                                                                                                                                                                                                                                                                                            }} ?>
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    <?php if ($response['deskloguser'] == 1) {
                                                                       if($response['sep_desktop'] !== '' && $response['sep_desktop'] !== null){ 
                                                                        if ((explode(":", $response['sep_desktop'])[0] > 0) || (explode(":", $response['sep_desktop'])[1] > 0)) { ?><span class="badge <?= ((explode(":", $response['sep_desktop'])[0] >= 172) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="<?= base_url('public/uploads/desktop-app-icon.png')?>" alt="" class="desklog-icon"> <?= $response['sep_desktop'] ?></span><?php }
                                                                                                                                                                                                                                                                                            }} ?>
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    <?php if ($response['deskloguser'] == 1) {
                                                                       if($response['oct_desktop'] !== '' && $response['oct_desktop'] !== null){ 
                                                                        if ((explode(":", $response['oct_desktop'])[0] > 0) || (explode(":", $response['oct_desktop'])[1] > 0)) { ?><span class="badge <?= ((explode(":", $response['oct_desktop'])[0] >= 172) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="<?= base_url('public/uploads/desktop-app-icon.png')?>" alt="" class="desklog-icon"> <?= $response['oct_desktop'] ?></span><?php }
                                                                                                                                                                                                                                                                                            }} ?>
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    <?php if ($response['deskloguser'] == 1) {
                                                                       if($response['nov_desktop'] !== '' && $response['nov_desktop'] !== null){ 
                                                                        if ((explode(":", $response['nov_desktop'])[0] > 0) || (explode(":", $response['nov_desktop'])[1] > 0)) { ?><span class="badge <?= ((explode(":", $response['nov_desktop'])[0] >= 172) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="<?= base_url('public/uploads/desktop-app-icon.png')?>" alt="" class="desklog-icon"> <?= $response['nov_desktop'] ?></span><?php }
                                                                                                                                                                                                                                                                                            }} ?>
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    <?php if ($response['deskloguser'] == 1) {
                                                                       if($response['dec_desktop'] !== '' && $response['dec_desktop'] !== null){ 
                                                                        if ((explode(":", $response['dec_desktop'])[0] > 0) || (explode(":", $response['dec_desktop'])[1] > 0)) { ?><span class="badge <?= ((explode(":", $response['dec_desktop'])[0] >= 172) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="<?= base_url('public/uploads/desktop-app-icon.png')?>" alt="" class="desklog-icon"> <?= $response['dec_desktop'] ?></span><?php }
                                                                                                                                                                                                                                                                                            }} ?>
                                                                </td>
                                                            </tr>
                                                    <?php }
