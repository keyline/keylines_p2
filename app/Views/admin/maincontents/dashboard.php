                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          ...
                                          <!-- </?php if($response['deskloguser'] == 1) { if ($response['jan_desktop_app'] > 0) { ?><span class="badge </?= (($response['jan_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="</?= base_url('public/uploads/desklog-icon.webp')?>" alt="" class="desklog-icon"> </?= $response['jan_desktop_app'] ?></span></?php } }?> -->
                                          <?php if($response['deskloguser'] == 1) { if ($response['jan_desktop_app'] > 0) { ?><span class="badge <?= (($response['jan_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"> <?= $response['jan_desktop_app'] ?></span><?php } }?>
                                       </td>
                                       <td>
                                          ...
                                          <!-- </?php if($response['deskloguser'] == 1) { if ($response['feb_desktop_app'] > 0) { ?><span class="badge </?= (($response['feb_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="</?= base_url('public/uploads/desklog-icon.webp')?>" alt="" class="desklog-icon"> </?= $response['feb_desktop_app'] ?></span></?php } }?> -->
                                          <?php if($response['deskloguser'] == 1) { if ($response['feb_desktop_app'] > 0) { ?><span class="badge <?= (($response['feb_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"> <?= $response['feb_desktop_app'] ?></span><?php } }?>
                                       </td>
                                       <td>
                                          ...
                                          <!-- </?php if($response['deskloguser'] == 1) { if ($response['mar_desktop_app'] > 0) { ?><span class="badge </?= (($response['mar_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="</?= base_url('public/uploads/desklog-icon.webp')?>" alt="" class="desklog-icon"> </?= $response['mar_desktop_app'] ?></span></?php } }?> -->
                                          <?php if($response['deskloguser'] == 1) { if ($response['mar_desktop_app'] > 0) { ?><span class="badge <?= (($response['mar_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"> <?= $response['mar_desktop_app'] ?></span><?php } }?>
                                       </td>
                                       <td>
                                          ...
                                          <!-- </?php if($response['deskloguser'] == 1) { if ($response['apr_desktop_app'] > 0) { ?><span class="badge </?= (($response['apr_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="</?= base_url('public/uploads/desklog-icon.webp')?>" alt="" class="desklog-icon"> </?= $response['apr_desktop_app'] ?></span></?php } }?> -->
                                          <?php if($response['deskloguser'] == 1) { if ($response['apr_desktop_app'] > 0) { ?><span class="badge <?= (($response['apr_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"> <?= $response['apr_desktop_app'] ?></span><?php } }?>
                                       </td>
                                       <td>
                                          ...
                                          <!-- </?php if($response['deskloguser'] == 1) { if ($response['may_desktop_app'] > 0) { ?><span class="badge </?= (($response['may_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="</?= base_url('public/uploads/desklog-icon.webp')?>" alt="" class="desklog-icon"> </?= $response['may_desktop_app'] ?></span></?php } }?> -->
                                          <?php if($response['deskloguser'] == 1) { if ($response['may_desktop_app'] > 0) { ?><span class="badge <?= (($response['may_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"> <?= $response['may_desktop_app'] ?></span><?php } }?>
                                       </td>
                                       <td>
                                          ...
                                          <!-- </?php if($response['deskloguser'] == 1) { if ($response['jun_desktop_app'] > 0) { ?><span class="badge </?= (($response['jun_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="</?= base_url('public/uploads/desklog-icon.webp')?>" alt="" class="desklog-icon"> </?= $response['jun_desktop_app'] ?></span></?php } }?> -->
                                          <?php if($response['deskloguser'] == 1) { if ($response['jun_desktop_app'] > 0) { ?><span class="badge <?= (($response['jun_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"> <?= $response['jun_desktop_app'] ?></span><?php } }?>
                                       </td>
                                       <td>
                                          ...
                                          <!-- </?php if($response['deskloguser'] == 1) { if ($response['jul_desktop_app'] > 0) { ?><span class="badge </?= (($response['jul_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="</?= base_url('public/uploads/desklog-icon.webp')?>" alt="" class="desklog-icon"> </?= $response['jul_desktop_app'] ?></span></?php } }?> -->
                                          <?php if($response['deskloguser'] == 1) { if ($response['jul_desktop_app'] > 0) { ?><span class="badge <?= (($response['jul_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"> <?= $response['jul_desktop_app'] ?></span><?php } }?>
                                       </td>
                                       <td>
                                          ...
                                          <!-- </?php if($response['deskloguser'] == 1) { if ($response['aug_desktop_app'] > 0) { ?><span class="badge </?= (($response['aug_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="</?= base_url('public/uploads/desklog-icon.webp')?>" alt="" class="desklog-icon"> </?= $response['aug_desktop_app'] ?></span></?php } }?> -->
                                          <?php if($response['deskloguser'] == 1) { if ($response['aug_desktop_app'] > 0) { ?><span class="badge <?= (($response['aug_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"> <?= $response['aug_desktop_app'] ?></span><?php } }?>
                                       </td>
                                       <td>
                                          ...
                                          <!-- </?php if($response['deskloguser'] == 1) { if ($response['sep_desktop_app'] > 0) { ?><span class="badge </?= (($response['sep_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="</?= base_url('public/uploads/desklog-icon.webp')?>" alt="" class="desklog-icon"> </?= $response['sep_desktop_app'] ?></span></?php } }?> -->
                                          <?php if($response['deskloguser'] == 1) { if ($response['sep_desktop_app'] > 0) { ?><span class="badge <?= (($response['sep_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"> <?= $response['sep_desktop_app'] ?></span><?php } }?>
                                       </td>
                                       <td>
                                          ...
                                          <!-- </?php if($response['deskloguser'] == 1) { if ($response['oct_desktop_app'] > 0) { ?><span class="badge </?= (($response['oct_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="</?= base_url('public/uploads/desklog-icon.webp')?>" alt="" class="desklog-icon"> </?= $response['oct_desktop_app'] ?></span></?php } }?> -->
                                          <?php if($response['deskloguser'] == 1) { if ($response['oct_desktop_app'] > 0) { ?><span class="badge <?= (($response['oct_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"> <?= $response['oct_desktop_app'] ?></span><?php } }?>
                                       </td>
                                       <td>
                                          ...
                                          <!-- </?php if($response['deskloguser'] == 1) { if ($response['nov_desktop_app'] > 0) { ?><span class="badge </?= (($response['nov_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="</?= base_url('public/uploads/desklog-icon.webp')?>" alt="" class="desklog-icon"> </?= $response['nov_desktop_app'] ?></span></?php } }?> -->
                                          <?php if($response['deskloguser'] == 1) { if ($response['nov_desktop_app'] > 0) { ?><span class="badge <?= (($response['nov_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"> <?= $response['nov_desktop_app'] ?></span><?php } }?>
                                       </td>
                                       <td>
                                          ...
                                          <!-- </?php if($response['deskloguser'] == 1) { if ($response['dec_desktop_app'] > 0) { ?><span class="badge </?= (($response['dec_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"><img src="</?= base_url('public/uploads/desklog-icon.webp')?>" alt="" class="desklog-icon"> </?= $response['dec_desktop_app'] ?></span></?php } }?> -->
                                          <?php if($response['deskloguser'] == 1) { if ($response['dec_desktop_app'] > 0) { ?><span class="badge <?= (($response['dec_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"> <?= $response['dec_desktop_app'] ?></span><?php } }?>
                                       </td>
                                    </tr>
                                    <?php }
                                       } ?>
                                    ...
                                    <tr>
                                       ...
                                       <?php                                          
                                          if ($date_difference == 0 && $report['booked_effort'] != 0) {
                                             ...
                                             echo ($report['deskloguser'] == 1) ? '<span class="badge badge-tracker-success cursor-pointer">' : '';
                                          ...
                                          elseif ($date_difference > 1 && $report['booked_effort'] != 0) {
                                             ...
                                             echo ($report['deskloguser'] == 1) ? '<span class="badge badge-tracker-warrning cursor-pointer">' : '';
                                             echo ($report['deskloguser'] == 1) ? '' . $report['desklog_time'] : '';
                                             echo '</span>';
                                          } elseif ($date_difference <= 1 && $report['booked_effort'] != 0) {
                                             ...
                                             echo ($report['deskloguser'] == 1) ? '<span class="badge badge-desktime-success cursor-pointer">' : '';
                                             echo ($report['deskloguser'] == 1) ? '' . $report['desklog_time'] : '';
                                             echo '</span>';
                                          }
                                          ...
                                          if($report['booked_effort'] == 0)
                                          {
                                             ...
                                             echo ($report['deskloguser'] == 1) ? '<span class="badge badge-tracker-holiday cursor-pointer">' : '';
                                             echo ($report['deskloguser'] == 1) ? '' . $report['desklog_time'] : '';
                                             echo '</span>';
                                          }
