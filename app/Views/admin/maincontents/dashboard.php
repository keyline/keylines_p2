                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          ...
                                          <?php if($response['deskloguser'] == 1) { if ($response['jan_desktop_app'] > 0) { ?><span class="badge <?= (($response['jan_desktop_app'] >= $application_settings->monthly_minimum_effort_time) ? 'badge-desktime-success' : 'badge-desktime-danger') ?>"> <img src="<?= base_url('public/uploads/desktop-app-icon.png')?>" alt="" class="desklog-icon"> <?= $response['jan_desktop_app'] ?></span><?php } }?>
                                       </td>
                                       <td>
                                    ...
                                    <tr>
                                       ...
                                       <?php                                          
                                          if ($date_difference == 0 && $report['booked_effort'] != 0) {
                                             ...
                                             echo ($report['deskloguser'] == 1) ? '<span class="badge badge-tracker-success cursor-pointer"><img src="' . base_url('public/uploads/desktop-app-icon.png') . '" alt="" class="desklog-icon">' : '';
                                          ...
                                          elseif ($date_difference > 1 && $report['booked_effort'] != 0) {
                                             ...
                                             echo ($report['deskloguser'] == 1) ? '<span class="badge badge-tracker-warrning cursor-pointer"><img src="' . base_url('public/uploads/desktop-app-icon.png') . '" alt="" class="desklog-icon">' : '';
                                             echo ($report['deskloguser'] == 1) ? '' . $report['desklog_time'] : '';
                                             echo '</span>';
                                          } elseif ($date_difference <= 1 && $report['booked_effort'] != 0) {
                                             ...
                                             echo ($report['deskloguser'] == 1) ? '<span class="badge badge-desktime-success cursor-pointer"><img src="' . base_url('public/uploads/desktop-app-icon.png') . '" alt="" class="desklog-icon">' : '';
                                             echo ($report['deskloguser'] == 1) ? '' . $report['desklog_time'] : '';
                                             echo '</span>';
                                          }
                                          ...
                                          if($report['booked_effort'] == 0)
                                          {
                                             ...
                                             echo ($report['deskloguser'] == 1) ? '<span class="badge badge-tracker-holiday cursor-pointer"><img src="' . base_url('public/uploads/desktop-app-icon.png') . '" alt="" class="desklog-icon">' : '';
                                             echo ($report['deskloguser'] == 1) ? '' . $report['desklog_time'] : '';
                                             echo '</span>';
                                          }
