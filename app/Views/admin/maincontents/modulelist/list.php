<div class="pcoded-content">
    ...
    <?php if(checkModuleFunctionAccess(13,4)){ ?>
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <?php } ?>
                    <?php if(checkModuleFunctionAccess(13,5)){ ?>
                    <h5>
                        ...
                        <table id="simpletable" class="table table-striped table-bordered nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <?php if(checkModuleFunctionAccess(13,6)){ ?>
                                    ...
                                    <?php } ?>
                                    &nbsp;&nbsp;&nbsp;
                                    <?php if(checkModuleFunctionAccess(13,62)){ ?>
                                    ...
                                    <?php // }?>
                                    <!-- &nbsp;&nbsp;&nbsp;
                                    <a class="btn btn-warning btn-sm" href="<?=base_url('admin/userPermission/'.$row->id)?>"><i class="nav-icon fas fa-key"></i> Permission</a> -->
                                  </td>
                                </tr>
                                <?php } }?>
                            </tbody>
