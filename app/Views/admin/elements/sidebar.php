...
<ul class="nav-links">
    ...
    <li>
      <div class="iocn-link">
        <a class="<?= (($pageSegment == 'projects') ? 'active' : '') ?>"
          ...
          <span class="link_name">Projects and Clients</span>
          <i class='bx bxs-chevron-down arrow ms-auto'></i>
        </a>
      </div>
      <ul class="sub-menu">
  ...
  <?php if (checkModuleAccess(16) || checkModuleAccess(17) || checkModuleAccess(29) || checkModuleAccess(30) || checkModuleAccess(37) || checkModuleAccess(38) || checkModuleAccess(32)) { ?>
    <li>
      <div class="iocn-link">
